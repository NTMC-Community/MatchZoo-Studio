                    ...
                    <el-row>
                        ...
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Number of units in first mlp_num_layers layers." placement="right-start">
                            <el-form-item label="filters">
                              <el-input-number v-model="filters" :min="120" :max="150"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
                      ...
                      <el-col :span="11">
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Number of units of the layer that connects the multiple layer percetron and the output." placement="right-start">
                            <el-form-item label="max_ngram">
                              <el-input-number v-model="max_ngram" :min="2" :max="4"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Number of units in first mlp_num_layers layers." placement="right-start">
                            <el-form-item label="kernel_num">
                              <el-input-number v-model="kernel_num" :min="8" :max="16"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
...
<script>
  ...
  import MatrixConvknrm from '../MatrixConvknrm'
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        var dataobject = {
          ...
          max_ngram: this.max_ngram,
          kernel_num: this.kernel_num,
        ...
        axios.post('./train/head/conv_knrm', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/conv_knrm', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/conv_knrm', obj).then(function (response) {
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/conv_knrm', obj).then(function (response) {
