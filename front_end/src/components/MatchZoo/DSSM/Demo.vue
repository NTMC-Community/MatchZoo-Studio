  ...
  export default {
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        axios.post('./train/head/dssm', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/dssm', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/dssm', obj).then(function (response) {
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/dssm', obj).then(function (response) {
