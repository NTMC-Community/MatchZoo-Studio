                    ...
                    <el-row>
                      ...
                      <el-col :span="11">
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Kernel count of 1D convolution layer." placement="right-start">
                            <el-form-item label="kernel_1d_count">
                              <el-input-number v-model="kernel_1d_count" :min="20" :max="50"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Kernel size of 1D convolution layer." placement="right-start">
                            <el-form-item label="kernel_1d_size">
                              <el-input-number v-model="kernel_1d_size" :min="1" :max="10"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        var dataobject = {
          ...
          kernel_1d_count: this.kernel_1d_count,
          kernel_1d_size: this.kernel_1d_size,
        ...
        axios.post('./train/head/arcii', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/arcii', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/arcii', obj).then(function (response) {
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/arcii', obj).then(function (response) {
