                  ...
                  <el-card style="margin-bottom: 20px">
                    ...
                    <el-row>
                        ...
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Should be set manually." placement="right-start">
                            <el-form-item label="embedding_output_dim">
                              <el-input-number v-model="embedding_output_dim" :min="1" :max="500"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Number of 2D convolution blocks." placement="right-start">
                            <el-form-item label="left_filters">
                              <el-input-number v-model="left_filters" :min="100" :max="200"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Number of 2D convolution blocks." placement="right-start">
                            <el-form-item label="left_kernel_sizes">
                              <el-input-number v-model="left_kernel_sizes" :min="1" :max="5"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Number of 2D convolution blocks." placement="right-start">
                            <el-form-item label="left_pool_sizes">
                              <el-input-number v-model="left_pool_sizes" :min="1" :max="5"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Number of 2D convolution blocks." placement="right-start">
                            <el-form-item label="mlp_num_layers">
                              <el-input-number v-model="mlp_num_layers" :min="1" :max="3"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Number of 2D convolution blocks." placement="right-start">
                            <el-form-item label="mlp_num_units">
                              <el-input-number v-model="mlp_num_units" :min="50" :max="150"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
                        </el-form>
                      </el-col>
                      ...
                      <el-col :span="11">
                        <el-form label-width="130px" label-position="left" size="small">
                          <el-tooltip class="item" effect="dark" content="Number of 2D convolution blocks." placement="right-start">
                            <el-form-item label="num_blocks">
                              <el-input-number v-model="num_blocks" :min="1" :max="10"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Should be set manually." placement="right-start">
                            <el-form-item label="right_filters">
                              <el-input-number v-model="right_filters" :min="100" :max="150"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Number of 2D convolution blocks." placement="right-start">
                            <el-form-item label="right_kernel_sizes">
                              <el-input-number v-model="right_kernel_sizes" :min="1" :max="5"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Number of 2D convolution blocks." placement="right-start">
                            <el-form-item label="right_pool_sizes">
                              <el-input-number v-model="right_pool_sizes" :min="1" :max="5"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Number of 2D convolution blocks." placement="right-start">
                            <el-form-item label="mlp_num_fan_out">
                              <el-input-number v-model="mlp_num_fan_out" :min="1" :max="10"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        var dataobject = {
          ...
          left_kernel_sizes: this.left_kernel_sizes,
          left_pool_sizes: this.left_pool_sizes,
          right_filters: this.right_filters,
          right_kernel_sizes: this.right_kernel_sizes,
          right_pool_sizes: this.right_pool_sizes,
        ...
        axios.post('./train/head/arci', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/arci', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/arci', obj).then(function (response) {
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/arci', obj).then(function (response) {
