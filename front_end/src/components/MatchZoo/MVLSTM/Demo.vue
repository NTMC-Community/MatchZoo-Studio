                        ...
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Should be set manually." placement="right-start">
                            <el-form-item label="embedding_output_dim">
                              <el-input-number v-model="embedding_output_dim" :min="50" :max="150"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Integer, the hidden size in the bi-directional LSTM layer." placement="right-start">
                            <el-form-item label="lstm_units">
                              <el-input-number v-model="lstm_units" :min="30" :max="60"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Integer, the size of top-k pooling layer." placement="right-start">
                            <el-form-item label="top_k">
                              <el-input-number v-model="top_k" :min="15" :max="25"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
                        ...
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Number of units in first mlp_num_layers layers." placement="right-start">
                            <el-form-item label="mlp_num_units">
                              <el-input-number v-model="mlp_num_units" :min="5" :max="15"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
                          ...
                          <el-tooltip class="item" effect="dark" content="Number of layers of the multiple layer percetron." placement="right-start">
                            <el-form-item label="mlp_num_layers">
                              <el-input-number v-model="mlp_num_layers" :min="1" :max="5"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        var dataobject = {
          ...
          lstm_units: this.lstm_units,
          top_k: this.top_k,
          mlp_num_layers: this.mlp_num_layers,
          mlp_num_units: this.mlp_num_layers,
        ...
        axios.post('./train/head/mvlstm', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/mvlstm', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/mvlstm', obj).then(function (response) {
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/mvlstm', obj).then(function (response) {
