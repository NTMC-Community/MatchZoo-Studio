                    ...
                    <el-row>
                      ...
                      <el-col :span="11">
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="The number of RBF kernels." placement="right-start">
                            <el-form-item label="kernel_num">
                              <el-input-number v-model="kernel_num" :min="20" :max="25"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
  ...
  export default {
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        axios.post('./train/head/krnm', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/knrm', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/knrm', obj).then(function (response) {
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/knrm', obj).then(function (response) {
