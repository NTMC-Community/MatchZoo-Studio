                    ...
                    <el-row>
                      <el-col :span="12">
                        ...
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Should be set manually." placement="right-start">
                            <el-form-item label="embedding_output_dim">
                              <el-input-number v-model="embedding_output_dim" :min="200" :max="500"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Filter size of 1D convolution layer in the local model." placement="right-start">
                            <el-form-item label="lm_filters">
                              <el-input-number v-model="lm_filters" :min="1" :max="50"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="A list of hidden size of the MLP layer in the local model." placement="right-start">
                            <el-form-item label="lm_hidden_sizes">
                              <el-input-number v-model="lm_hidden_sizes" :min="1" :max="50"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="Filter size of 1D convolution layer in the distributed model." placement="right-start">
                            <el-form-item label="dm_filters">
                              <el-input-number v-model="dm_filters" :min="1" :max="50"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
                      ...
                      <el-col :span="11">
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Kernel size of 1D convolution layer in the distributed model." placement="right-start">
                            <el-form-item label="dm_kernel_size">
                              <el-input-number v-model="dm_kernel_size" :min="1" :max="5"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="	Max pooling size for the right text in the distributed model." placement="right-start">
                            <el-form-item label="dm_d_mpool">
                              <el-input-number v-model="dm_d_mpool" :min="1" :max="5"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="A list of hidden size of the MLP layer in the distributed model." placement="right-start">
                            <el-form-item label="dm_hidden_sizes">
                              <el-input-number v-model="dm_hidden_sizes" :min="1" :max="50"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
        ...
        <el-card>
          <el-scrollbar style="height:100%;">
            ...
            <div v-if="!show_train_card">
              ...
              <matrixmatchpyramid></matrixmatchpyramid>
            </div>
          </el-scrollbar>
        </el-card>
      </el-col>
...
<script>
  ...
  import MatrixMatchPyramid from '../MatrixMatchPyramid'
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        var dataobject = {
          ...
          embedding_output_dim: this.embedding_output_dim,
          lm_filters: this.lm_filters,
          lm_hidden_sizes: this.lm_hidden_sizes,
          dm_filters: this.dm_filters,
          dm_kernel_size: this.dm_kernel_size,
          dm_d_mpool: this.dm_d_mpool,
          dm_hidden_sizes: this.dm_hidden_sizes,
        ...
        axios.post('./train/head/duet', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/duet', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/duet', obj).then(function (response) {
        ...
        function setTrainData () {
          ...
          myself.loss_min_height = Math.max(0, minv - half_loss_height)
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/duet', obj).then(function (response) {
