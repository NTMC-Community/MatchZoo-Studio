  ...
  export default {
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        axios.post('./train/head/anmm', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/anmm', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/anmm', obj).then(function (response) {
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/anmm', obj).then(function (response) {
    ...
    mounted: function () {
      ...
      var leftCard = document.querySelector('.el-card__body')
      ...
      document.querySelectorAll('.el-card__body')[2].style.height = winHeight - 60 - 20 - titleHeight - 40 - 10 + 'px'
