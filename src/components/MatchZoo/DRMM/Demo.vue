                        ...
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Number of units of the layer that connects the multiple layer percetron and the output." placement="right-start">
                            <el-form-item label="mlp_num_fan_out">
                              <el-input-number v-model="mlp_num_fan_out" :min="1" :max="5"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
                        ...
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Should be set manually." placement="right-start">
                            <el-form-item label="embedding_output_dim">
                              <el-input-number v-model="embedding_output_dim" :min="250" :max="350"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="The value to be masked from inputs." placement="right-start">
                            <el-form-item label="mask_value">
                              <el-input-number v-model="mask_value" :min="0" :max="1"></el-input-number>
                            </el-form-item>
                          </el-tooltip>

                          <el-tooltip class="item" effect="dark" content="top-k" placement="right-start">
                            <el-form-item label="top-k">
                              <el-input-number v-model="top_k" :min="10" :max="30"></el-input-number>
                            </el-form-item>
                          </el-tooltip>
                        </el-form>
                      </el-col>
...
<script>
  ...
  import MatrixDRMM from '../MatrixDRMM'
  ...
  export default {
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        axios.post('./train/head/drmm', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/drmm', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/drmm', obj).then(function (response) {
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/drmm', obj).then(function (response) {
    ...
    mounted: function () {
      ...
      // console.log(winHeight - 60 - 20 - titleHeight - 40 - 10 + 'px')
