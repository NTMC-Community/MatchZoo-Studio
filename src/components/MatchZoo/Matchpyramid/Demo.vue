                  ...
                  <el-card style="margin-bottom: 20px">
                    ...
                    <el-row>
                      <el-col :span="12">
                        <!-- 每个模型不同的部分：修改开始 -->
                        <el-form label-width="130px" label-position="left" size="small">
                          <el-tooltip class="item" effect="dark" content="Usually equals vocab size + 1. Should be set manually." placement="right-start">
                      ...
                      <el-col :span="11">
                        <el-form label-width="130px" label-position="left" size="small">
                          ...
                          <el-tooltip class="item" effect="dark" content="Number of convolution blocks." placement="right-start">
  ...
  export default {
    ...
    methods: {
      ...
      sendTrainHead: function () {
        ...
        axios.post('./train/head/matchpyramid', head_obj).then(function (response) {
      ...
      clickTrain: function () {
        ...
        function getPreprocessData () {
          ...
          axios.post('./preprocess/matchpyramid', obj).then(function (response) {
        ...
        function getTrainData () {
          ...
          axios.post('./train/query/matchpyramid', obj).then(function (response) {
      ...
      clickPredict: function () {
        ...
        if (this.end_train === false) {
          ...
          axios.post('./predict/matchpyramid', obj).then(function (response) {
